...
* Download the latest binary:
  ...
  **Linux (x86_64):**
  ...
  ```console
  curl -L -o opencode-sandbox https://github.com/inoio/opencode-sandbox/-/releases/permalink/latest/downloads/opencode-sandbox-linux-amd64
  ```

  **macOS (Apple Silicon):**

  ```console
  curl -L -o opencode-sandbox https://github.com/inoio/opencode-sandbox/-/releases/permalink/latest/downloads/opencode-sandbox-darwin-arm64
  ```

  **Linux (arm64):**

  ```console
  curl -L -o opencode-sandbox https://github.com/inoio/opencode-sandbox/-/releases/permalink/latest/downloads/opencode-sandbox-linux-arm64
  ```
* Install:
  ```console
